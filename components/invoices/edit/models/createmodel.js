export const INVOICE_CREATE_MODEL = {
    ...
    ERROR_MESSAGE: {
        INVOICE_CREATED_BY_DOCUMENT: `The system cannot get configuration. Please contact system administrator.`,
        INVOICE_ITEM_DEFAULT_GROUPING: `The system cannot get configuration. Please contact system administrator.`
    },
    BTN_SEARCH: {
    ...
    MODEL_PO_COLUMN: [
        ...
        },
        {
            ...
            "export": true,
            "defaultExport": true,
            "optClassName": "text-uppercase mw-container text-left"
        },
        {
            "columnIndex": 3,
            "defaultOrder": 3,
        ...
        },
        {
            ...
            render: function (txt, row, col) {
                let poAmount = row.initialTotal.quantity * row.initialTotal.displayTokenSize;
