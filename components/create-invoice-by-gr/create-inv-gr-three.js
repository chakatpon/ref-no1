...
class createInvoiceByGrStepThree extends Component {
  constructor(props) {
    super(props);
    this.state = {
      blocking: false,
  ...
  async getConfiguration() {
    ...
    let businessPlaceTaxNumber = this.props.mainState.stepTwoProp.populatedPO[0]
  ...
  async getCalculatedDueDate() {
    ...
    let businessPlaceTaxNumber = this.props.mainState.stepOneProp.selectedPO
      .businessPlaceTaxNumber;
    let calendarKeys = this.props.mainState.stepTwoProp.selectedGRItems[
      this.props.mainState.stepTwoProp.populatedPO[0].poNumber
    ]["item"][0].poItem.calendarKey;
...
export default createInvoiceByGrStepThree;
