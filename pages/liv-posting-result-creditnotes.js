  ...
  _columnRender = async () => {
    ...
    this.columnList.setCustomFormat("externalId", {
      ...
      render: function(data, type, row) {
        ...
        return `<a href="/credit-note-detail?${qq}&ref=liv,${row.linearId}" data-href="/credit-note-detail?${qq}&ref=liv,${row.linearId}"  className="link list-link">${data}</a>`;
      }
    });
